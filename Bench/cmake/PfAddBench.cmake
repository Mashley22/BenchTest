...
define_property(GLOBAL PROPERTY PF_BENCH_PATHS BRIEF_DOCS "Collected target output paths")

function(pf_add_bench)
    ...
    get_property(existing_paths GLOBAL PROPERTY PF_BENCH_PATHS)
    list(APPEND existing_paths "${target_path}")
    set_property(GLOBAL PROPERTY PF_BENCH_PATHS "${existing_paths}")
endfunction()

# Function to write target paths to file after config
function(pf_write_all_bench_paths)
  get_property(all_paths GLOBAL PROPERTY PF_BENCH_PATHS)
