...
define_property(GLOBAL PROPERTY BENCHTEST_BENCH_PATHS BRIEF_DOCS "Collected target output paths")

function(benchtest_add_bench)
    ...
    get_property(existing_paths GLOBAL PROPERTY BENCHTEST_BENCH_PATHS)
    list(APPEND existing_paths "${target_path}")
    set_property(GLOBAL PROPERTY BENCHTEST_BENCH_PATHS "${existing_paths}")
endfunction()

# Function to write target paths to file after config
function(benchtest_write_all_bench_paths)
  get_property(all_paths GLOBAL PROPERTY BENCHTEST_BENCH_PATHS)
  set(output_file "${CMAKE_SOURCE_DIR}/PfBenchLists.txt")
    ...
    message(STATUS "Wrote benchs list to: ${output_file}")
endfunction()
